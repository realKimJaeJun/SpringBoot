...
public class MainController {
	...
	public String query4() {
		...
		User1VO user = repo.findUser1VOByUidAndName("a203", "이순신");
	...
	public String query8() {
		...
		List<User1VO> users = repo.findUser1VOByAgeLessThan(27);
	...
	public String query10() {
		...
		List<User1VO> users = repo.findUser1VOByNameLike("이순신");
	...
	public String query11() {
		...
		List<User1VO> users = repo.findUser1VOByNameContains("춘");
	...
	public String query13() {
		...
		List<User1VO> users = repo.findUser1VOByNameEndsWith("신");
	...
	public String query18() {
		...
		int count = repo.countUser1VOByUid("a203");
	...
	public String query19() {
		...
		int count = repo.countUser1VOByName("김유신");
	...
	public String query21() {
		...
		List<User1VO> users = repo.selectUserByName("이순신");
